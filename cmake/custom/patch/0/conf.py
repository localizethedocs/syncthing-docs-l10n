...
extlinks = {
    'issue': ('https://github.com/syncthing/syncthing/issues/%s', 'issue #%s'), # [patch]
    'user': ('https://github.com/%s', '@%s'),                                   # [patch]
    'commit': ('https://github.com/syncthing/syncthing/commit/%s', None),       # [patch]
}
...
def setup(app):
    app.add_css_file("syncthing.css") # [patch] Since add_stylesheet() is removed in Sphinx 6.0
